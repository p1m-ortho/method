...
См. историю коммитов для файла `METHOD.md`. См. например для этого репозитория: https://github.com/p1m-ortho/xk-p1m-ortho-method/commits/master/METHOD.md.

Так же по аналогии и для других репозиториев в p1m-ortho.

Все правки по методам для репозитория, очевидно, необходимо вносить туда же, в `METHOD.md`.
