...
## Оповещение
Поскольку состав участников `p1m-ortho` на момент этого коммита выполнен целиком студентами и ординаторами, то и методичка рассчитана сейчас сугубо на эти контингенты. По мере расширения круга участников методичка может быть значительно изменена. Методичку предлагается читать с конца. p1m — это [Pavlov 1st Medical](http://en.1spbgmu.ru).
...
### Комментарии к коммитам. Три хороших комментария
#### 1
```
...
* Здесь три простые причины.
    ...
    * (3) Журналы часто хотят транслитерацию по ГОСТу, то есть именно такую.
...
### Сокращения. ISO 3166-1 alpha-2. LTWA
...
### Краткий ответ на вопрос, зачем нам этот GitHub
Git — 👍. Word — 👎.
...
Что это означает? На самом деле, ряд вещей. Желающие ознакомиться с классическим определением могут сделать это здесь:
https://handbook-5-1.cochrane.org/chapter_1/1_2_2_what_is_a_systematic_review.htm.
...
Здесь будет ссылка на список персоналий.
