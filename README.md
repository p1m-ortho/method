...
### Сокращения. ISO 3166-1 alpha-2. LTWA ISSN
...
* Еще по поводу сокращений. Есть обширнейший словарь сокращений слов под названием LTWA ISSN. Им пользуются, например, при сокращении названий журналов. Какое-нибудь _Int J Surg_ — это по этому словарю. Когда в каком-то названии хотите сократить слово, пользуйтесь и вы этим словарем.
